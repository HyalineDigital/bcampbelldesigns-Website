...
const projectsRaw: Project[] = [
  ...
  },
  {
    ...
    keyResults: [
      "The mobile app concept centers around a functionality reminiscent of TikTok or Youtube shorts \"feeds,\" offering a dynamic and swift approach to maintain high user retention and maximize game discoverability within the extensive AG collection. The key features of the home feed include presenting users with the most popular games upon app launch and subsequently displaying content akin to their previous gameplay on subsequent visits, ideally leveraging tags or similar signals. Users can seamlessly swipe up or down to navigate between games. Upon selecting a game of interest, tapping the play button in the navigation initiates gameplay. Once engaged in a game, users can access additional options by tapping the top-left arrow, enabling actions such as liking, sharing, or exiting the game. Importantly, the gameplay view is designed to be free of intrusive elements, minimizing the risk of accidental touch-triggered disruptions. Once the app was released revenue generated by Addicting Games increased by 12% month over month and had 16k downloads in its first month. *The company was sold and the app is currently not on the app store as of Apr 20th 2024 due to it not being maintained and the app falling out of the app stores guidelines, this is supposed to be reuploaded later in 2024.",
    ],
    images: [
